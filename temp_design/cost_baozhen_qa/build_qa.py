...
OUTPUT = Path(__file__).with_name("cost_baozhen_qa.docx")
...
assert result["usage_results"][0]["final_price"] == "675.3", result["usage_results"][0]["final_price"]
...
print(OUTPUT)
print(result["usage_results"][0]["location_correction_rate"])
